...
contract pStrudelERC20 is Divine {
  using SafeMath for uint256;
  ...
  constructor() Divine( "pORKAN", "pORKAN", 18 ) {
    uint256 initialSupply_ = 60 * 1000 * 1000 * 1e18; //writing out 60 million ether units the long way to be safe
  ...
  function _beforeTokenTransfer(address from_, address to_, uint256 amount_ ) internal override {
    require( (_balances[to_] > 0 || isApprovedSeller[from_] == true), "Account not approved to transfer pORKAN." );
  }
