...
contract StrudelPresale is ReentrancyGuard, Context, Ownable, Pausable {
    ...
    */
    function setToken(address _token) external onlyOwner {
        require(_token != address(0x0), "Pre-Sale: Token is the zero address");
        token = _token;
    ...
    /**
    * @notice If something goes wrong you can still set the persons distrubited amount.
    ...
    */
    ...
    /**
    * Claim FTM only available for the treasury address
    */
    ...
    */
    ...
    /**
    * @notice returns the whitelistSigner if the signature is whitelisted
    * @param _beneficiary Wallet address of whitelister
    * @param signature The signature of the signed whitelister
    */
