...
contract StrudelStaking is Ownable {
    ...
    /**
        @notice stake ORKAN to enter warmup
        @param _amount uint
        @return bool
     */
    ...
    /**
        @notice retrieve sORKAN from warmup
    ...
    /**
        @notice forfeit sORKAN in warmup and retrieve ORKAN
     */
    ...
    /**
        @notice redeem sORKAN for ORKAN
        @param _amount uint
        @param _trigger bool
     */
    ...
    /**
        @notice returns the sORKAN index, which tracks rebase growth
        @return uint
     */
    ...
    /**
        @notice returns contract ORKAN holdings, including bonuses provided
        @return uint
     */
