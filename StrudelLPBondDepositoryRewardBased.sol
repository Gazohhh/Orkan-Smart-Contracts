...
contract StrudelLPBondDepositoryRewardBased is Ownable {
    ...
    address public immutable treasury; // mints ORKAN when receives principal
    ...
    function deposit( 
        ...
        IERC20( principal ).safeTransfer( address( treasury ), _amount );
        ITreasury(treasury).mintRewards(address(this), profit);
    ...
    /**
     *  @notice allow anyone to send lost tokens (excluding principal or ORKAN) to the DAO
     *  @return bool
     */
