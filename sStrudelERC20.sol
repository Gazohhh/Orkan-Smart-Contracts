...
contract sStrudel is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Orkan", "sORKAN", 9) ERC20Permit() {
    ...
    /**
        @notice increases sORKAN supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sORKAN
